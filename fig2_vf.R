...
data3 <- data[, c("iso3", "if_bws", "ifsmh",  "fsystem", "crop_name", "HarvestedArea", "vf_production_t",
                  "vf_Energy_kcal", "vf_total_water_m3", "vf_green_water_m3", "vf_blue_water_m3", "vf_Iron_mg", 
                  "vf_Zinc_mg", "vf_Vitamin.A..expressed.in.retinol.equivalents._mcg", 
                  "vf_Folate..dietary.folate.equivalents..mcg._mcg",
                  "vf_Vitamin.B12_mcg","vf_Calcium_mg")]

colnames(data3) <- c("iso3", "if_bws", "ifsmh",  "fsystem", "crop_name", "HarvestedArea", "production_t",
